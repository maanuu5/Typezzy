        ...
        {state !== "done" && (
          <div className="absolute right-0" ref={menuRef}>
            ...
            >
                ...
                {/* GitHub */}
                <a
                  href="https://github.com/maanuu5/Typezzy"
                  target="_blank"
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-3 w-full px-4 py-2.5 text-[#646669] transition-colors hover:bg-[#3a3a3c] text-[10px] leading-tight"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polygon points="12 2 2 12 12 22 22 12"/><line x1="12" y1="8" x2="12" y2="16"/><line x1="8" y1="12" x2="16" y2="12"/></svg>
                  <span>Love the keyboard? Check out <span className="text-[#d1d0c5]">Aceternity UI</span></span>
                </a>
              </div>
          </div>
        )}
